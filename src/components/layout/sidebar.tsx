...
import { SupportModal } from './sidebar/support-modal'
...
export function Sidebar({ className, onNavAction }: SidebarProps) {
    ...
    const [supportModalType, setSupportModalType] = useState<'support' | 'feedback'>('support')
            ...
            >
                ...
                <div className="flex-col gap-1 p-2 shrink-0 flex">
                    ...
                    <ProfileDropdown
                        ...
                        user={user}
                        side="right"
                        onSupportClick={() => { setSupportModalType('support'); setSupportModalOpen(true) }}
                        onFeedbackClick={() => { setSupportModalType('feedback'); setSupportModalOpen(true) }}
                    />
